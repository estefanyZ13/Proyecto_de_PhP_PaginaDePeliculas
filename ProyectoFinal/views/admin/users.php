                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <?php if ($u['id'] !== (int)$_SESSION['user_id']): ?>
                                                <form action="" method="POST" style="display:inline;" onsubmit="return confirm('¿Eliminar usuario?');">
                                                    <?php csrfField(); ?>
                                                    <input type="hidden" name="user_id" value="<?php echo $u['id']; ?>">
                                                    <button type="submit" name="delete_user" class="btn btn-delete btn-sm">🗑️ Eliminar</button>
                                                </form>
                                            <?php else: ?>
